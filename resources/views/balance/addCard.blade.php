<x-layout>
    ...
    <div id="main" class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
        ...
        <form method="POST" action="/dashboard/payments/store" class="flex flex-wrap gap-3 w-full p-5">
            @csrf
            <label class="relative w-full flex flex-col">
                <span class="font-bold mb-3">Card number</span>
                <input class="rounded-md peer pl-12 pr-2 py-2 border-2 border-gray-200 placeholder-gray-300" required type="number"
            ...
            <label class="relative flex-1 flex flex-col">
                ...
                <input class="rounded-md peer pl-12 pr-2 py-2 border-2 border-gray-200 placeholder-gray-300" required type="text"
...
<div class="container">
            @error('cardNumber')
            <p class="text-red-500 text-xs mt-1">Invalid card data</p>
            @enderror
</div>
        </form>
    </div>
